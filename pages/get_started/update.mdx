...
Depending on how you chose to launch your customer, you can update it in the same way by choosing the appropriate category:
...
First, navigate to your Madara project directory and fetch the latest changes from the Official [Madara](https://github.com/KasarLabs/deoxys) repository.
...
Next, update your Rust toolchain and dependencies to ensure compatibility with the latest code changes.
