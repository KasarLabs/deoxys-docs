...
<Callout type="info" emoji="ℹ️">
  **Info**: Deoxys is currently supporting the latest version of Starknet mainnet official [JSON-RPC specs](https://github.com/starkware-libs/starknet-specs). For more informations regarding the current and upcoming releases please reffer to the [Version](/about/version) section.
</Callout>
...
<Callout type="warning" emoji="⚠">
  **Warning**: Please refer to the official [JSON-RPC specs](https://github.com/starkware-libs/starknet-specs) for up to date data.
</Callout>

<Callout type="info" emoji="ℹ️">
  **Info**: You can play with the [Voyager playground](https://rpc-request-builder.voyager.online/) or the [OPEN-RPC](https://playground.open-rpc.org/?uiSchema%5BappBar%5D%5Bui:splitView%5D=false&schemaUrl=https://raw.githubusercontent.com/starkware-libs/starknet-specs/master/api/starknet_api_openrpc.json&uiSchema%5BappBar%5D%5Bui:input%5D=false&uiSchema%5BappBar%5D%5Bui:darkMode%5D=true&uiSchema%5BappBar%5D%5Bui:examplesDropdown%5D=false) interface to get more familiar with those methods.
</Callout>
