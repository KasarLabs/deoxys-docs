...
* Archive Sync
	...
	* Heavy storage usage
	* Not available on Deoxys nodes yet
...
They're some additional modes you may want to use when syncing a Deoxys instance, for exemple for dev purposes 
...
<Callout type="warning" emoji="⚠️">
	Syncing a node in `--disable-root` means that you're not verifying the integrity of the state you're currently syncing. Only do it if you're aware of what you're doing.
</Callout>